...
} from "../../features/erp-core/models/erp-core.models";
...
export class ApiClientService {
  ...
  getApiContracts(): Observable<ApiContractSnapshot> {
    return this.get<ApiContractSnapshot>("/contratos");
  }
  ...
  uploadProductImage(
    ...
    return this.http
      .post<
        ApiResponse<string>
      >(`${this.baseUrl}/productos/${productId}/imagen`, formData)
  ...
  downloadRecipePdf(productId: number): Observable<Blob> {
    return this.http.get(
      `${this.baseUrl}/abastecimiento/recetas/producto/${productId}/pdf`,
      {
        responseType: "blob",
      },
    );
  ...
  downloadGuiaOperativaManual(): Observable<Blob> {
    return this.download("/casos-uso/manual.pdf");
  }
  ...
  registrarDocumentoCompra(
    ordenId: number,
    payload: RegistrarDocumentoCompraRequest,
  ): Observable<CompraFinancieraSummary> {
    return this.post<CompraFinancieraSummary>(
      `/abastecimiento/ordenes-compra/${ordenId}/documento-compra`,
      payload,
    );
  }
  ...
  getDocumentoCompraOrden(
    ...
    return this.get<CompraFinancieraSummary>(
      `/abastecimiento/ordenes-compra/${ordenId}/documento-compra`,
    );
  }

  getCuentasPagar(estado = ""): Observable<DocumentoPagarSummary[]> {
    const suffix = estado ? `?estado=${encodeURIComponent(estado)}` : "";
    return this.get<DocumentoPagarSummary[]>(
      `/abastecimiento/cuentas-pagar${suffix}`,
    );
  }
  ...
  // === ERP CORE TRANSVERSAL ===

  getTerceros(
    perfil?: TerceroPerfil | "",
    query = "",
  ): Observable<TerceroSummary[]> {
    const params = this.buildQuery({ perfil, query });
    return this.get<TerceroSummary[]>(`/terceros${params}`);
  }

  getDocumentosCobrar(estado = ""): Observable<DocumentoCobrarSummary[]> {
    const params = this.buildQuery({ estado });
    return this.get<DocumentoCobrarSummary[]>(
      `/cartera/documentos-cobrar${params}`,
    );
  }

  getDocumentoCobrar(documentoId: number): Observable<DocumentoCobrarSummary> {
    return this.get<DocumentoCobrarSummary>(
      `/cartera/documentos-cobrar/${documentoId}`,
    );
  }

  createDocumentoCobrar(
    payload: CrearDocumentoCobrarRequest,
  ): Observable<DocumentoCobrarSummary> {
    return this.post<DocumentoCobrarSummary>(
      "/cartera/documentos-cobrar",
      payload,
    );
  }

  getCobranzas(): Observable<CobranzaSummary[]> {
    return this.get<CobranzaSummary[]>("/cartera/cobranzas");
  }

  registrarCobranza(
    payload: RegistrarCobranzaRequest,
  ): Observable<CobranzaSummary> {
    return this.post<CobranzaSummary>("/cartera/cobranzas", payload);
  }

  getDocumentosPagar(estado = ""): Observable<DocumentoPagarSummary[]> {
    const params = this.buildQuery({ estado });
    return this.get<DocumentoPagarSummary[]>(
      `/cuentas-pagar/documentos${params}`,
    );
  }

  getPagosProveedor(): Observable<PagoProveedorSummary[]> {
    return this.get<PagoProveedorSummary[]>("/cuentas-pagar/pagos");
  }

  registrarPagoProveedor(
    payload: RegistrarPagoProveedorRequest,
  ): Observable<PagoProveedorSummary> {
    return this.post<PagoProveedorSummary>("/cuentas-pagar/pagos", payload);
  }

  getCuentasContables(): Observable<CuentaContableSummary[]> {
    return this.get<CuentaContableSummary[]>("/contabilidad/cuentas");
  }

  getTiposDiarioContable(): Observable<TipoDiarioSummary[]> {
    return this.get<TipoDiarioSummary[]>("/contabilidad/diarios");
  }

  getAsientosContables(): Observable<AsientoContableSummary[]> {
    return this.get<AsientoContableSummary[]>("/contabilidad/asientos");
  }

  getAsientoContable(asientoId: number): Observable<AsientoContableSummary> {
    return this.get<AsientoContableSummary>(
      `/contabilidad/asientos/${asientoId}`,
    );
  }

  registrarAsientoContable(
    payload: RegistrarAsientoContableRequest,
  ): Observable<AsientoContableSummary> {
    return this.post<AsientoContableSummary>("/contabilidad/asientos", payload);
  }

  getDocumentosFiscales(): Observable<DocumentoFiscalSummary[]> {
    return this.get<DocumentoFiscalSummary[]>("/fiscal/documentos");
  }

  getDocumentoFiscal(documentoId: number): Observable<DocumentoFiscalSummary> {
    return this.get<DocumentoFiscalSummary>(
      `/fiscal/documentos/${documentoId}`,
    );
  }

  prepararDocumentoFiscal(
    payload: RegistrarDocumentoFiscalRequest,
  ): Observable<DocumentoFiscalSummary> {
    return this.post<DocumentoFiscalSummary>("/fiscal/documentos", payload);
  }

  emitirDocumentoFiscalInterno(
    documentoId: number,
  ): Observable<DocumentoFiscalSummary> {
    return this.post<DocumentoFiscalSummary>(
      `/fiscal/documentos/${documentoId}/emitir-interno`,
      {},
    );
  }
  ...
  anularDocumentoFiscal(
    documentoId: number,
    payload: AnularDocumentoFiscalRequest,
  ): Observable<DocumentoFiscalSummary> {
    return this.post<DocumentoFiscalSummary>(
      `/fiscal/documentos/${documentoId}/anular`,
      payload,
    );
  }
  ...
  generarDocumentoCobrarDesdePedido(
    pedidoId: number,
  ): Observable<ErpBridgeOperationResult> {
    return this.post<ErpBridgeOperationResult>(
      `/erp-bridges/pedidos/${pedidoId}/documento-cobrar`,
      {},
    );
  }
  ...
  generarAsientoVentaDesdeDocumentoCobrar(
    ...
    return this.post<ErpBridgeOperationResult>(
      `/erp-bridges/documentos-cobrar/${documentoCobrarId}/asiento-venta`,
      {},
    );
  }
  ...
  generarAsientoCobroDesdeCobranza(
    ...
    return this.post<ErpBridgeOperationResult>(
      `/erp-bridges/cobranzas/${cobranzaId}/asiento-cobro`,
      {},
    );
  }
  ...
  generarAsientoCompraDesdeDocumentoPagar(
    ...
    return this.post<ErpBridgeOperationResult>(
      `/erp-bridges/documentos-pagar/${documentoPagarId}/asiento-compra`,
      {},
    );
  }
  ...
  generarAsientoPagoProveedor(
    ...
    return this.post<ErpBridgeOperationResult>(
      `/erp-bridges/pagos-proveedor/${pagoProveedorId}/asiento-pago`,
      {},
    );
  }

  getErpDashboard(): Observable<DashboardErpSummary> {
    return this.get<DashboardErpSummary>("/inteligencia/dashboard");
  }

  getInteligenciaCartera(limit = 50): Observable<CarteraSemanticRow[]> {
    return this.get<CarteraSemanticRow[]>(
      `/inteligencia/cartera${this.buildQuery({ limit })}`,
    );
  }

  getInteligenciaCuentasPagar(
    limit = 50,
  ): Observable<CuentasPagarSemanticRow[]> {
    return this.get<CuentasPagarSemanticRow[]>(
      `/inteligencia/cuentas-pagar${this.buildQuery({ limit })}`,
    );
  }

  getInteligenciaCaja(limit = 50): Observable<CajaMovimientoSemanticRow[]> {
    return this.get<CajaMovimientoSemanticRow[]>(
      `/inteligencia/caja${this.buildQuery({ limit })}`,
    );
  }

  getInteligenciaContabilidad(
    limit = 50,
  ): Observable<ContabilidadSemanticRow[]> {
    return this.get<ContabilidadSemanticRow[]>(
      `/inteligencia/contabilidad${this.buildQuery({ limit })}`,
    );
  }

  getInteligenciaFiscal(limit = 50): Observable<FiscalSemanticRow[]> {
    return this.get<FiscalSemanticRow[]>(
      `/inteligencia/fiscal${this.buildQuery({ limit })}`,
    );
  }

  getInteligenciaStockBajo(limit = 50): Observable<StockBajoSemanticRow[]> {
    return this.get<StockBajoSemanticRow[]>(
      `/inteligencia/stock-bajo${this.buildQuery({ limit })}`,
    );
  }
  ...
  private download(path: string): Observable<Blob> {
