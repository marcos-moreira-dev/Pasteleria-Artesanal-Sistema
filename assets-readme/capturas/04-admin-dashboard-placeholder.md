# 04 Admin Dashboard Placeholder

- `asset_id`: `admin-dashboard`
- `ruta_esperada`: `assets-readme/capturas/04-admin-dashboard.png`
- `estado`: `placeholder`
- `uso`: mostrar la visión operativa general del negocio
