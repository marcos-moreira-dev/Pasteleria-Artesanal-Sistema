# 05 Admin Clientes Placeholder

- `asset_id`: `admin-clientes`
- `ruta_esperada`: `assets-readme/capturas/05-admin-clientes.png`
- `estado`: `placeholder`
- `uso`: evidenciar gestión de clientes y seguimiento comercial
