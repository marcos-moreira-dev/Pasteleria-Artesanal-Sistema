# 07 Admin Producción Placeholder

- `asset_id`: `admin-produccion`
- `ruta_esperada`: `assets-readme/capturas/07-admin-produccion.png`
- `estado`: `placeholder`
- `uso`: mostrar cómo el sistema aterriza el trabajo de cocina y despacho
