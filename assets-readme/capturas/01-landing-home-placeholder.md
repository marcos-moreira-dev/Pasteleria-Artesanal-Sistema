# 01 Landing Home Placeholder

- `asset_id`: `landing-home`
- `ruta_esperada`: `assets-readme/capturas/01-landing-home.png`
- `estado`: `placeholder`
- `uso`: primera captura del README propagandístico
