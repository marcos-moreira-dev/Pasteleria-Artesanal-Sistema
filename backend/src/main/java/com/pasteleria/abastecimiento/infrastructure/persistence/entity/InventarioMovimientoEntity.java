 ...
 *   <li><b>SALIDA_PRODUCCION</b>: Consumo para órdenes de producción (cantidad < 0)</li>
 *   <li><b>SALIDA_MERMA</b>: Pérdida por vencimiento, daño, etc. (cantidad < 0)</li>
 *   <li><b>SALIDA_AJUSTE</b>: Corrección negativa de inventario (cantidad < 0)</li>
 * </ul>
 * 
 * <h2>CAMPOS PRINCIPALES</h2>
 * <ul>
 *   <li><b>cantidad</b>: Monto del movimiento (positivo para entradas, negativo para salidas)</li>
 *   <li><b>saldoPosterior</b>: Stock resultante después del movimiento (para trazabilidad)</li>
