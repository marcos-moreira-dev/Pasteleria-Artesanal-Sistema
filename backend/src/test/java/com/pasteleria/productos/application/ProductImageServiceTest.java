...
class ProductImageServiceTest {
  ...
  void setUp() {
    imageService = new ProductImageService(
        productRepository,
        new StorageProperties(tempDir.toString(), null)
    );
  }
  ...
  void shouldUploadImageSuccessfully() throws IOException {
    ...
    assertThat(result).isEqualTo("/api/v1/assets/products/torta-chocolate.jpg");
  ...
  void shouldAcceptUppercaseExtension() throws IOException {
    ...
    assertThat(result).isEqualTo("/api/v1/assets/products/producto-test.png");
  }
